...
const Landing: React.FC = () => {
  ...
  return (
    <div
      className={`${styles.landingPage} bg-background-light font-display text-gray-800 dark:bg-background-dark dark:text-gray-200`}
    >
        ...
        <div className="relative z-10 flex flex-1 flex-col">
          ...
          <main className="flex-1 px-6 pb-4 pt-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Ready to dive in?</h2>
              <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">Let's get you a fun nickname!</p>
            </div>
            <div className="mt-8">
            ...
            <div className="mt-10">
              <h3 className="text-center text-xl font-bold text-gray-900 dark:text-white">Choose your AI companion</h3>
              <fieldset className="mt-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  <div>
                    ...
                    <label
                      className="flex cursor-pointer flex-col items-center justify-center rounded-xl border border-gray-300 bg-white p-6 text-center shadow-md transition-all peer-checked:border-primary peer-checked:bg-primary/10 peer-checked:text-primary dark:border-gray-700 dark:bg-background-dark/50 dark:peer-checked:bg-primary/30 dark:peer-checked:text-primary"
                      htmlFor="simple"
                    >
                      <span className="text-2xl font-bold">The Chill Buddy</span>
                      <span className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        Casual chats &amp; good vibes
                      </span>
                    </label>
                  </div>
                  <div>
          ...
          <div className="px-6 pb-6">
            <button
              className="w-full rounded-xl bg-primary py-4 text-lg font-bold text-white shadow-lg shadow-primary/30 transition-transform duration-200 ease-in-out hover:scale-[1.02] active:scale-95"
